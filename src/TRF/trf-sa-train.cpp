...
// 		lout_variable(nIterPerEpoch);
		...
		double *pdCurParams = new double[m_pfunc->GetParamNum()]; //��ǰ����x_k
		double *pdCurGradient = new double[m_pfunc->GetParamNum()]; //��ǰ���ݶ� df_k
		double *pdCurDir = new double[m_pfunc->GetParamNum()]; // current update direction
 		double dCurValue = 0; // ����ֵ f_k
		double dExValues[Func::cn_exvalue_max_num]; // �����������
		double nExValueNum; // �������ݵĴ�С
