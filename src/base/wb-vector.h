...
#define VECTOR_bits2Size(n) (1<<n)
	...
	*/
	 ...
	 * \brief Dynamic array
	 * \note
		ʹ�ô˶�̬����ʱ��a[i] = a[j]�����ڲ���ȡ�����Ǳ�֤i��j��������Խ�磬���������ڵ�ǰ��BufferSize��	
		���ڴ˹����У�i>j����i�Ѿ�Խ�磬���i����ʱ�����¿����ڴ棬����j���ص����ã���ʵ���ǵ�ַ������Ч�ˡ�
		����������ʱ�����������м���̣�
		temp = a[j];
		a[i] = temp;
		��.������һ��������ͬʱ���ʶ�����ݣ����Ǳ�֤ÿ�����ʶ���Խ�硣
